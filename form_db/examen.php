...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <img src="icons/bootstrap-logo.svg" alt="" width="30" height="24">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">Examenes</a>
                </li>
            </ul>
            <form class="d-flex">
    ...
    <a href="views/almacen.php" class="btn btn-success">Agregar Nuevo</a>
    <?php
        include 'db/db.php';
            ...
            while($row = mysqli_fetch_assoc($result)){
                echo "
                    <tr>
                        ...
                        <td>$row[note]</td>
                        <td>$row[enable]</td>
                        <td><a href='views/editarExam.php?id=$row[id]' class='btn btn-warning'><img src='icons/pencil-solid.svg'></a></td>
        ...
        <!-- <form method="post"> -->
            ...
            <div class="modal-body">
                <form enctype="multipart/form-data" method="post">
                    ...
                    <button type="submit" class="btn btn-primary" name="save" onclick="deleteRecordExam()" style="position: absolute; top: calc(100% + 10px);">Save changes</button>
                    <style>.modal-footer { justify-content: center; }
                           .modal-footer .btn {margin: 0 5px; }</style>
                </form>
            </div>
